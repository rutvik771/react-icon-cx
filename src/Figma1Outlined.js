...
const SvgFigma1Outlined = (props) => (
  ...
  >
    ...
    <path
      fill="#000"
      d="M10 18.75c-1.52 0-2.75-1.23-2.75-2.75s1.23-2.75 2.75-2.75h2.75V16c0 1.52-1.23 2.75-2.75 2.75Zm0-4A1.25 1.25 0 1 0 11.25 16v-1.25H10Zm4-4h-2.75v-5.5H14c1.52 0 2.75 1.23 2.75 2.75s-1.23 2.75-2.75 2.75Zm-1.25-1.5H14a1.25 1.25 0 0 0 0-2.5h-1.25v2.5Z"
    />
    <path
      fill="#000"
...
export default SvgFigma1Outlined;
