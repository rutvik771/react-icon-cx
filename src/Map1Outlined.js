...
const SvgMap1Outlined = (props) => (
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M15 22.75H9c-1.1 0-2.04-.09-2.9-.29a.728.728 0 0 1-.55-.52c-.08-.26 0-.54.19-.74l7.73-7.73c.29-.29.77-.29 1.06 0l6.38 6.38a.75.75 0 0 1 0 1.06c-1.27 1.26-3.14 1.84-5.91 1.84Zm-7.15-1.54c.36.03.74.04 1.15.04h6c1.92 0 3.29-.3 4.26-.93L14 15.06l-6.15 6.15Zm1.27-7.9c-.63 0-1.26-.23-1.76-.7-1.59-1.51-2.23-3.17-1.85-4.79.38-1.66 1.83-2.78 3.61-2.78 1.78 0 3.23 1.12 3.61 2.78.37 1.63-.27 3.28-1.86 4.79-.49.46-1.12.7-1.75.7ZM6.97 8.15c-.32 1.36.6 2.58 1.43 3.37.41.39 1.04.39 1.44 0 .82-.78 1.74-2 1.43-3.37C11 6.96 9.94 6.53 9.12 6.53c-.82 0-1.87.43-2.15 1.62Z"
    />
    <path
      fill="#292D32"
      d="M9.15 9.49c-.55 0-1-.45-1-1s.44-1 1-1h.01c.55 0 1 .45 1 1s-.46 1-1.01 1Z"
    />
  </svg>
);

export default SvgMap1Outlined;
