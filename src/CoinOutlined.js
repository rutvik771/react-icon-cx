...
const SvgCoinOutlined = (props) => (
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M10 14.34c-.41 0-.75-.34-.75-.75v-.74c0-.41.34-.75.75-.75s.75.34.75.75v.74c0 .42-.34.75-.75.75Zm0-6.4c-.41 0-.75-.34-.75-.75v-.78c0-.41.34-.75.75-.75s.75.34.75.75v.78c0 .41-.34.75-.75.75Z"
    />
    <path
      fill="#292D32"
    ...
    <path
      fill="#292D32"
      d="M17.02 22.72a5.7 5.7 0 0 1-4.66-2.42.753.753 0 1 1 1.23-.87 4.197 4.197 0 0 0 7.63-2.42c0-1.35-.66-2.63-1.76-3.42a.751.751 0 1 1 .88-1.22 5.72 5.72 0 0 1 2.38 4.64 5.7 5.7 0 0 1-5.7 5.71Z"
    />
  </svg>
);
