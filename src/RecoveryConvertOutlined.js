...
const SvgRecoveryConvertOutlined = (props) => (
  <svg
  ...
  >
    <path
      fill="#292D32"
      d="M11.42 19.25H8.69C6 19.25 4.75 18 4.75 15.31v-2.73C4.75 9.9 6 8.65 8.69 8.65h2.73c2.68 0 3.94 1.25 3.94 3.94v2.73c-.01 2.68-1.26 3.93-3.94 3.93Zm-2.73-9.1c-1.87 0-2.44.57-2.44 2.44v2.73c0 1.87.57 2.44 2.44 2.44h2.73c1.87 0 2.44-.57 2.44-2.44v-2.73c0-1.87-.57-2.44-2.44-2.44H8.69Z"
    />
    <path
      fill="#292D32"
...
export default SvgRecoveryConvertOutlined;
