...
const SvgDocumentFavoriteOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M22 10.75h-4c-3.42 0-4.75-1.33-4.75-4.75V2c0-.3.18-.58.46-.69.28-.12.6-.05.82.16l8 8a.751.751 0 0 1-.53 1.28Zm-7.25-6.94V6c0 2.58.67 3.25 3.25 3.25h2.19l-5.44-5.44ZM9.42 18.95c-.87 0-2.89-1.06-3.51-3-.43-1.34.07-3.09 1.62-3.59.65-.21 1.34-.12 1.89.22.54-.34 1.24-.43 1.9-.22 1.55.5 2.05 2.25 1.62 3.59-.63 1.98-2.75 3-3.52 3ZM7.33 15.5c.42 1.31 1.84 1.93 2.1 1.95.28-.03 1.68-.72 2.07-1.95.21-.66 0-1.5-.65-1.71-.27-.09-.64-.04-.81.22-.14.21-.36.33-.61.34a.72.72 0 0 1-.62-.31c-.21-.29-.57-.33-.83-.24-.64.2-.86 1.04-.65 1.7Z"
    />
  </svg>
);

export default SvgDocumentFavoriteOutlined;
