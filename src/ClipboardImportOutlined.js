...
const SvgClipboardImportOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M14 22.75H9c-5.62 0-6.75-2.58-6.75-6.75v-6c0-4.56 1.65-6.51 5.71-6.72.4-.02.77.29.79.71.02.42-.3.76-.71.78C5.2 4.93 3.75 5.78 3.75 10v6c0 3.7.73 5.25 5.25 5.25h5c.41 0 .75.34.75.75s-.34.75-.75.75Zm7-7c-.41 0-.75-.34-.75-.75v-5c0-4.22-1.45-5.07-4.29-5.23a.757.757 0 0 1-.71-.79c.02-.41.39-.73.79-.71 4.06.22 5.71 2.17 5.71 6.72v5c0 .42-.34.76-.75.76Zm0 7h-3c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h2.25V19c0-.41.34-.75.75-.75s.75.34.75.75v3c0 .41-.34.75-.75.75Z"
    />
    <path
      fill="#292D32"
      d="M20.96 22.71c-.19 0-.38-.07-.53-.22l-5.96-5.96a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l5.96 5.96c.29.29.29.77 0 1.06-.15.14-.34.22-.53.22Z"
    />
  </svg>
);

export default SvgClipboardImportOutlined;
