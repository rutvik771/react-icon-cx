...
const SvgFolderFavoriteOutlined = (props) => (
  <svg
  ...
  >
    <path
      fill="#292D32"
      d="M12 17.88c-.25 0-.51-.09-.71-.27l-2.58-2.26c-.97-.85-1.1-2.31-.29-3.32a2.4 2.4 0 0 1 3.33-.42l.25.19.26-.2a2.4 2.4 0 0 1 3.33.42c.81 1.01.68 2.47-.29 3.32l-2.58 2.26c-.21.19-.47.28-.72.28Zm-2.31-3.66L12 16.24l2.31-2.02c.37-.32.42-.87.11-1.25a.903.903 0 0 0-1.26-.16l-.71.53c-.27.2-.63.2-.9 0l-.71-.53a.904.904 0 0 0-1.26.16c-.3.38-.25.93.11 1.25Z"
    />
    <path
      fill="#292D32"
...
export default SvgFolderFavoriteOutlined;
