...
const SvgWallet1Bold = (props) => (
  ...
  >
    <path
      fill="#292D32"
      d="M11.94 2.21 9.53 7.82H7.12c-.4 0-.79.03-1.17.11l1-2.4.04-.09.06-.16c.03-.07.05-.13.08-.18 1.16-2.69 2.46-3.53 4.81-2.89Zm6.79 5.88-.02-.01c-.6-.17-1.21-.26-1.83-.26h-6.26l2.25-5.23.03-.07c.14.05.29.12.44.17l2.21.93c1.23.51 2.09 1.04 2.62 1.68.09.12.17.23.25.36.09.14.16.28.2.43.04.09.07.17.09.26.15.51.16 1.09.02 1.74Zm-6.21 9.57h.25c.3 0 .55-.27.55-.6 0-.42-.12-.48-.38-.58l-.42-.15v1.33Z"
    />
    <path
      fill="#292D32"
