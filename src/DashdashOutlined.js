...
const SvgDashdashOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#000"
      d="M9.19 14.25H2a.754.754 0 0 1-.73-.93l.37-1.48a2.74 2.74 0 0 1 2.67-2.08h7.19a.754.754 0 0 1 .73.93l-.37 1.48a2.76 2.76 0 0 1-2.67 2.08Zm-6.23-1.5h6.23c.57 0 1.07-.39 1.21-.95l.14-.55H4.31c-.57 0-1.07.39-1.21.95l-.14.55Z"
    />
  </svg>
);

export default SvgDashdashOutlined;
