...
const SvgGalleryFavoriteBold = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M20.97 1h-2.94c-.87 0-1.51.36-1.8 1-.16.29-.23.63-.23 1.03v2.94C16 7.24 16.76 8 18.03 8h2.94c.4 0 .74-.07 1.03-.23.64-.29 1-.93 1-1.8V3.03C23 1.76 22.24 1 20.97 1Zm-.67 5.21c-.32.19-.63.29-.8.29-.45 0-1.73-.62-2.11-1.82a1.836 1.836 0 0 1-.02-1.07c.13-.47.44-.88.96-1.05.2-.06.41-.08.6-.04.2.03.39.11.56.24.32-.25.76-.33 1.18-.2.91.3 1.2 1.33.94 2.12-.04.12-.09.24-.15.35-.27.54-.73.94-1.16 1.18Z"
    />
  </svg>
);
