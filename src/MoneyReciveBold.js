...
const SvgMoneyReciveBold = (props) => (
  <svg
  ...
  >
    <path
      fill="#292D32"
      d="M18.81 6.25h1.36c-.19-.27-.39-.52-.6-.77l-.76.77Zm-.29-1.83c-.25-.21-.5-.41-.77-.6v1.36l.77-.76Zm1.06 1.06 2.95-2.95c.29-.29.29-.77 0-1.06a.754.754 0 0 0-1.06 0l-2.95 2.95c.38.33.73.69 1.06 1.06ZM17.75 3c0-.41-.34-.75-.75-.75-.4 0-.72.32-.74.71.52.25 1.02.53 1.49.86V3Zm4 4c0-.41-.34-.75-.75-.75h-.83c.33.47.62.97.86 1.49.4-.02.72-.34.72-.74Zm-9 7.75h.3c.39 0 .7-.35.7-.78 0-.54-.15-.62-.49-.74l-.51-.18v1.7Z"
    />
    <path
      fill="#292D32"
