...
const SvgDesigntoolsBold = (props) => (
  <svg
  ...
  >
    <path
      fill="#292D32"
      d="m21.04 13.28-.92-.9-7.75 7.74.93.93c.78.78 1.59 1.17 2.39 1.17s1.61-.39 2.39-1.17l2.96-2.96c1.59-1.6 1.59-3.21 0-4.81ZM10.69 2.93c-1.57-1.57-3.22-1.57-4.79 0L2.93 5.89c-1.56 1.57-1.56 3.22 0 4.79l.92.92 7.75-7.75-.91-.92Zm11.12 1.01c-1.31 3.27-4.3 7.54-7.15 10.33a5.962 5.962 0 0 0-5.07-4.96c2.8-2.86 7.1-5.89 10.38-7.21.58-.22 1.16-.05 1.52.31.38.38.56.95.32 1.53Z"
    />
    <path
      fill="#292D32"
...
export default SvgDesigntoolsBold;
