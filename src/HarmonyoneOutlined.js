...
const SvgHarmonyoneOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#000"
      d="M18.26 22.75h-.52a4.49 4.49 0 0 1-4.49-4.49v-7.05l.66-.08c5.16-.6 7.47-3.56 7.49-3.59l1.35-1.77v12.48c0 2.49-2.01 4.5-4.49 4.5Zm-3.51-10.22v5.73c0 1.65 1.34 2.99 2.99 2.99h.52c1.65 0 2.99-1.34 2.99-2.99V9.78c-1.24.99-3.36 2.26-6.5 2.75ZM6.26 22.75h-.52a4.49 4.49 0 0 1-4.49-4.49c0-1.99.98-3.8 2.63-4.83 1.75-1.1 3.78-1.79 6.03-2.05l.84-.1v6.98a4.49 4.49 0 0 1-4.49 4.49Zm2.99-9.76c-1.7.29-3.23.87-4.57 1.71-1.19.75-1.93 2.11-1.93 3.56 0 1.65 1.34 2.99 2.99 2.99h.52c1.65 0 2.99-1.34 2.99-2.99v-5.27Z"
    />
    <path
      fill="#000"
...
export default SvgHarmonyoneOutlined;
