...
const SvgGraphOutlined = (props) => (
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M11.07 22.75c-.53 0-1.07-.04-1.61-.13-4.09-.66-7.42-3.98-8.08-8.07C.53 9.29 3.92 4.33 9.11 3.27c.41-.08.8.18.89.58.08.41-.18.8-.58.89-4.39.9-7.27 5.1-6.54 9.57.56 3.46 3.37 6.27 6.83 6.83 4.49.72 8.68-2.17 9.57-6.58a.75.75 0 1 1 1.47.29 9.852 9.852 0 0 1-9.68 7.9Z"
    />
  </svg>
);

export default SvgGraphOutlined;
