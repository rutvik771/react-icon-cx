...
const SvgReceiptTextOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M12 9.75H6c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75Zm-.75 4h-4.5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h4.5c.41 0 .75.34.75.75s-.34.75-.75.75Z"
    />
  </svg>
);

export default SvgReceiptTextOutlined;
