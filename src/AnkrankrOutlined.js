...
const SvgAnkrankrOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#000"
      d="M12 22.75c-.41 0-.75-.34-.75-.75v-5.56c0-.41.34-.75.75-.75s.75.34.75.75V22c0 .41-.34.75-.75.75Z"
    />
    <path
      fill="#000"
      d="M12 17.19c-2.86 0-5.19-2.33-5.19-5.19 0-2.86 2.33-5.19 5.19-5.19 2.86 0 5.19 2.33 5.19 5.19 0 2.86-2.33 5.19-5.19 5.19Zm0-8.88c-2.04 0-3.69 1.66-3.69 3.69A3.7 3.7 0 0 0 12 15.69 3.7 3.7 0 0 0 15.69 12c0-2.03-1.65-3.69-3.69-3.69Z"
    />
  </svg>
);

export default SvgAnkrankrOutlined;
