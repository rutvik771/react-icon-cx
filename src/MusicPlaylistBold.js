...
const SvgMusicPlaylistBold = (props) => (
  <svg
  ...
  >
    <path
      fill="#292D32"
      d="M18 5.25H6c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h12c.41 0 .75.34.75.75s-.34.75-.75.75Zm-3-2.5H9c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75Zm-1.09 13.46c-.34 0-.62.28-.62.62 0 .34.28.62.62.62.34 0 .62-.28.62-.62 0-.34-.28-.62-.62-.62Zm-4.4 1.53c0-.34-.28-.61-.62-.61-.34 0-.62.28-.62.62 0 .34.28.62.62.62.34-.01.62-.29.62-.63Z"
    />
    <path
      fill="#292D32"
...
export default SvgMusicPlaylistBold;
