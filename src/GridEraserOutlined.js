...
const SvgGridEraserOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M8.51 22.74c-.41 0-.75-.34-.75-.75V2.02c0-.41.34-.75.75-.75s.75.34.75.75v19.97c0 .41-.33.75-.75.75Zm7-10c-.41 0-.75-.34-.75-.75V2.02c0-.41.34-.75.75-.75s.75.34.75.75v9.97c0 .41-.33.75-.75.75Zm.44 10.01c-.54 0-1.07-.2-1.49-.61l-1.59-1.6c-.81-.81-.81-2.14 0-2.97l1.91-1.9c.29-.29.77-.29 1.06 0l3.5 3.5a.749.749 0 0 1 0 1.06l-1.9 1.9c-.42.41-.95.62-1.49.62Zm-.65-5.48-1.37 1.37a.61.61 0 0 0 0 .85l1.58 1.59c.23.23.62.23.85 0l1.38-1.37-2.44-2.44Z"
    />
    <path
      fill="#292D32"
...
export default SvgGridEraserOutlined;
