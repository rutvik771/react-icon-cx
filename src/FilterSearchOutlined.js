...
const SvgFilterSearchOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M16.07 17.27c-2.18 0-3.95-1.77-3.95-3.95s1.77-3.95 3.95-3.95 3.95 1.77 3.95 3.95-1.77 3.95-3.95 3.95Zm0-6.4c-1.35 0-2.45 1.1-2.45 2.45s1.1 2.45 2.45 2.45 2.45-1.1 2.45-2.45-1.1-2.45-2.45-2.45Z"
    />
    <path
      fill="#292D32"
      d="M19.87 17.87c-.19 0-.38-.07-.53-.22l-1-1a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l1 1c.29.29.29.77 0 1.06-.14.14-.34.22-.53.22Z"
    />
  </svg>
);

export default SvgFilterSearchOutlined;
