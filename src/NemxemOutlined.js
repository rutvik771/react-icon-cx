...
const SvgNemxemOutlined = (props) => (
  ...
  >
    ...
    <path
      fill="#000"
      d="M16.35 19.26c-.11 0-.22-.02-.32-.07a.75.75 0 0 1-.35-1c.01-.02.86-1.86.11-3.83-.58-1.52-1.95-2.75-4.08-3.67a.737.737 0 0 1-.39-.98c.17-.38.6-.56.99-.39 2.53 1.08 4.17 2.61 4.9 4.54.97 2.58-.12 4.89-.17 4.99-.14.25-.41.41-.69.41Z"
    />
  </svg>
);

export default SvgNemxemOutlined;
