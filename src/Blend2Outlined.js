...
const SvgBlend2Outlined = (props) => (
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M15.43 16.16c-.19 0-.38-.07-.53-.21l-1.3-1.28a.755.755 0 0 1-.01-1.06c.29-.29.76-.3 1.06-.01l1.3 1.28c.29.29.3.77.01 1.06-.14.14-.34.22-.53.22Zm1.54-3.41c-.19 0-.38-.07-.53-.22l-1-1a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l1 1c.29.29.29.77 0 1.06a.71.71 0 0 1-.53.22Zm-5 5c-.19 0-.38-.07-.53-.22l-1-1a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l1 1c.29.29.29.77 0 1.06a.71.71 0 0 1-.53.22Z"
    />
  </svg>
);

export default SvgBlend2Outlined;
