...
const SvgReceiveSquare2Outlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M14.83 14.09c-.19 0-.38-.07-.53-.22L8.64 8.21a.755.755 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l5.66 5.66c.29.29.29.77 0 1.06-.15.15-.34.22-.53.22ZM12 18.23c-2.11 0-4.23-.34-6.24-1.01a.753.753 0 0 1-.47-.95c.13-.39.56-.61.95-.47 3.72 1.24 7.81 1.24 11.53 0 .39-.13.82.08.95.47.13.39-.08.82-.47.95-2.02.68-4.14 1.01-6.25 1.01Z"
    />
  </svg>
);

export default SvgReceiveSquare2Outlined;
