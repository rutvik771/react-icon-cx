...
const SvgTreeOutlined = (props) => (
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M17.59 18.75H6.42c-1.43 0-2-.69-2.21-1.1-.21-.41-.43-1.27.41-2.43l3.99-5.6c.14-.2.37-.31.61-.31h5.57c.24 0 .47.12.61.31l3.99 5.61c.84 1.15.61 2.01.4 2.42-.21.41-.77 1.1-2.2 1.1ZM9.6 10.81 5.83 16.1c-.32.44-.35.74-.29.87.07.13.33.28.87.28h11.17c.54 0 .81-.15.87-.28.07-.13.03-.43-.29-.87l-3.77-5.3H9.6v.01Z"
    />
    <path
      fill="#292D32"
...
export default SvgTreeOutlined;
