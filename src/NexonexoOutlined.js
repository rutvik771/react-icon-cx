...
const SvgNexonexoOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#000"
      d="M7 21.75c-.13 0-.27-.04-.39-.11l-5-3a.742.742 0 0 1-.36-.64V6c0-.26.14-.51.36-.64l5-3c.24-.14.53-.14.77 0l5 3c.36.21.47.67.26 1.03-.21.36-.67.47-1.03.26L7 3.88 2.75 6.43v11.15l4.23 2.54 4.31-2.87c.34-.23.81-.14 1.04.21.23.35.14.81-.21 1.04l-4.7 3.13c-.13.08-.27.12-.42.12Z"
    />
  </svg>
);

export default SvgNexonexoOutlined;
