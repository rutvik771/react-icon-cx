...
const SvgInformationOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#292D32"
      d="M12 16.87c-.55 0-1-.45-1-1s.44-1 1-1c.55 0 1 .45 1 1s-.44 1-1 1Zm0-3.15c-.41 0-.75-.34-.75-.75V8.13c0-.41.34-.75.75-.75s.75.34.75.75v4.83c0 .42-.33.76-.75.76Z"
    />
  </svg>
);

export default SvgInformationOutlined;
