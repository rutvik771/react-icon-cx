...
const SvgWanchainWanOutlined = (props) => (
  <svg
  ...
  >
    ...
    <path
      fill="#000"
      d="M12 18.45c-.15 0-.29-.04-.42-.13l-2.25-1.5a.755.755 0 0 1-.21-1.04c.23-.35.7-.44 1.04-.21l1.83 1.22 1.83-1.22c.34-.23.81-.14 1.04.21.23.34.14.81-.21 1.04l-2.25 1.5a.62.62 0 0 1-.4.13Z"
    />
    <path
      fill="#000"
...
export default SvgWanchainWanOutlined;
